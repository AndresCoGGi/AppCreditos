...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tblusuarios.findByTrabaja", query = "SELECT t FROM Tblusuarios t WHERE t.trabaja = :trabaja")})
public class Tblusuarios implements Serializable {
    ...
    public Tblusuarios(String credito, String documento, String nombre, Double monto, String tipotrabajador, String tipocredito, String trabaja) {
    ...
    public String toString() {
        return "co.com.poli.appcreditos.model.Tblusuarios[ credito=" + credito + " ]";
    }
